...
<body>
	...
	<nav
		...
		<div class="container px-4 px-lg-5 mb-3">
			<a class="navbar-brand" href="/jeju">🍊Travel Jeju🍊</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto my-2 my-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="/jeju/board/restaurant">Board</a></li>
					<c:choose>
	...
	<div class="container pt-5 ps-0">
		<nav aria-label="breadcrumb">
			<ol
				...
				<li class="breadcrumb-item text-sm"><a
					class="opacity-5 text-dark" href="<c:url value="/listTourist"/>">Best
						Pick</a></li>
				...
				<div class="card card-body mt-4">
					...
					<form id="sortBy">
						...
						<label for="projectName" class="form-label">제목</label> <input
							...
							class="form-label mt-2">장소</label>
						<div class="col-6">
						...
						<label for="projectName" class="form-label">해시태그</label> <input
							type="text" class="form-control" name="hashtag" id="hashtag"
							placeholder="#태그 해주세요"> <label class="mt-4">내용</label>
						<p class="form-text text-muted text-xs ms-1 mb-2">이곳을 추천하는 이유를
							적어주세요</p>
						<div id="editor" class="ql-container ql-snow">
							<textarea name="description" id="description"
								class="form-control" data-gramm="false" contenteditable="true"
								maxlength='250' rows="8"><c:out value="${content}" /></textarea>
						</div>
						<label class="mt-4 mb-4 form-label">Starting Files</label>
						<!-- file add -->
					...
					<div class="d-flex justify-content-end mt-4">
						<button type="button" onclick="history.back()" name="button"
							class="btn btn-light btn-outline-dark m-0">Cancel</button>
	...
	<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(33.36209328052907,
					126.53147109994914), // 지도의 중심좌표
			level : 9
		// 지도의 확대 레벨
		};
		...
		function addMarker(position, idx, title) {
			...
			kakao.maps.event.addListener(marker, 'click',
					function() {
						var moveLatLon = new kakao.maps.LatLng(Object
								.values(position)[1],
